...
% : %.c ChainedList.o uvsqgraphics_2.o Button.o ImageFunctions.o Triangles.o
	$(CC) $(CFLAGS) -o $@ $< ChainedList.o uvsqgraphics_2.o Button.o ImageFunctions.o Triangles.o $(LDLIBS)
